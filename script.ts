...
const findNameOfTallestMontain = (anArrayOfMountains: Mountain[]): string => {
  ...
  let currentTallest: Mountain = anArrayOfMountains[0];
...
//mitch's solutions
//for loop
const findNameOfTallestMontain2 = (anArrayOfMountains: Mountain[]): string => {
  if (anArrayOfMountains.length === 0) {
    return ``;
  }
  let currentTallest: Mountain = anArrayOfMountains[0];
...
//for of loop
const findNameOfTallestMontain3 = (anArrayOfMountains: Mountain[]): string => {
  if (anArrayOfMountains.length === 0) {
    return ``;
  }
  let currentTallest: Mountain = anArrayOfMountains[0];
...
//reduce method
const findNameOfTallestMontain4 = (mountains: Mountain[]): string => {
...
const calcAverageProductPrice2 = (anArrayOfProducts: Product[]): number => {
  if (anArrayOfProducts.length === 0) {
    return 0;
  }
